    ...
    <section className="px-3 py-12">
      <div className="relative mx-auto max-w-[1400px] overflow-hidden rounded-3xl brand-gradient p-8 sm:p-12 lg:p-16">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          <div>
            <h2 className="font-manrope text-2xl font-extrabold leading-none tracking-tight text-transparent sm:text-3xl lg:text-4xl" style={{ WebkitTextStroke: "1.5px white" }}>
              ACO's
            </h2>
            <p className="mt-6 font-poppins text-md text-white sm:text-xl lg:text-2xl">
            ...
            >
                <span className="brand-gradient-text">Ecris moi en{" "}
                message privé</span>
            </a>
          </div>
