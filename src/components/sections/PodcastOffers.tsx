...
function VideoCard({ src, alt, link }: { src: string; alt: string, link: string }) {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-[#1a0a00] aspect-video">
      ...
      {/* Bouton play */}
      <a href={link} className="absolute bottom-4 left-4 inline-flex items-center gap-2.5 rounded-full bg-white/95 py-1.5 pl-1.5 pr-5 shadow-md transition hover:scale-[1.02]">
  ...
  return (
    <section id="interview-feature" className="bg-[#FAF8F4] px-6 lg:py-20 py-8">
      <div className="mx-auto max-w-[1200px]">
        ...
        {/* Titre principal */}
        <h2 className="mt-4 max-w-[720px] text-xl font-black leading-snug tracking-tight text-[#0f0f0f] sm:text-2xl">
          C'est ainsi que{" "}
        ...
        <div className="mt-12 flex flex-col gap-5">
          ...
          {/* Ligne 1 : Card gauche + Image droite */}
          ...
          {/* Ligne 2 : Image gauche + Card droite */}
